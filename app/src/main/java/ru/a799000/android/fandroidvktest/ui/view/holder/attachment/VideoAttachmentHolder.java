...
import ru.a799000.android.fandroidvktest.model.view.attachment.VideoAttachmentViewModel;
import ru.a799000.android.fandroidvktest.rest.api.VideoApi;
import ru.a799000.android.fandroidvktest.rest.model.request.VideoGetReqestModel;
    ...
    public void bindViewHolder(VideoAttachmentViewModel videoAttachmentViewModel) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mVideoApi.get(new VideoGetReqestModel(videoAttachmentViewModel.getOwnerId(), videoAttachmentViewModel.getId()).toMap())
